...
export default function WfWf(props) {
    ...
    const Features = (
        <React.Fragment>
            <SimpleGrid columns={{ base: 1, md: 3, lg: 5 }} pos="relative" gap={{ base: 6, sm: 8 }} px={5} py={6} p={{ sm: 8 }}>
                <Section
                    title="Analytics"
                    icon={
                        <path
            ...
            <Box px={{ base: 5, sm: 8 }} py={5} bg={hbg} display={{ sm: 'flex' }}>
                <Stack direction={{ base: 'row' }} spacing={{ base: 6, sm: 10 }}>
                    <Box display="flow-root">
                        <Link m={-3} p={3} display="flex" alignItems="center" rounded="md" fontSize="md" color={tcl} _hover={{ bg: hbgh }}>
                            <chakra.svg
                                flexShrink={0}
                                h={6}
                                w={6}
                            ...
                            >
                                ...
                                />
                                <path strokeLinecap="round" strokeLinejoin="round" stroke-w="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </chakra.svg>
                    ...
                    <Box display={{ base: 'none', md: 'inline-flex' }}>
                        <HStack spacing={1}>
                            <Box role="group">
                                ...
                                <Box pos="absolute" left={0} w="full" display="none" _groupHover={{ display: 'block' }}>
                                    {Features}
                                </Box>
                            </Box>
                            <Button
